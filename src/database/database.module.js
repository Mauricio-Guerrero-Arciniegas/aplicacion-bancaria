...
var transaction_model_1 = require("../transactions/models/transaction.model");
var DatabaseModule = function () {
            ...
            imports: [
                sequelize_1.SequelizeModule.forRootAsync({
                    ...
                    useFactory: function (config) { return ({
                        ...
                        models: [user_model_1.User, transaction_model_1.Transaction],
                        autoLoadModels: true,
                        synchronize: true,
                        logging: false,
                    }); },
    ...
    var DatabaseModule = _classThis = /** @class */ (function () {
        function DatabaseModule_1(sequelize) {
            this.sequelize = sequelize;
        }
        DatabaseModule_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.sequelize.sync({ alter: true })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
