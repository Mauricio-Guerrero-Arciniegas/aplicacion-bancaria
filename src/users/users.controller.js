...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.transfer = function (req, transferDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    user = req.user;
                    return [2 /*return*/, this.usersService.transfer(user.id, transferDto)];
                });
            });
        };
        UsersController_1.prototype.getTransactions = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    user = req.user;
                    return [2 /*return*/, this.usersService.getTransactions(user.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _transfer_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('transfer')];
        _getTransactions_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)('transactions')];
