...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.account_number = (__runInitializers(_this, _password_extraInitializers), __runInitializers(_this, _account_number_initializers, void 0));
            _this.balance = (__runInitializers(_this, _account_number_extraInitializers), __runInitializers(_this, _balance_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _balance_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _name_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING(100), allowNull: false })];
        _email_decorators = [sequelize_typescript_1.Unique, (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING(100), allowNull: false })];
        _password_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false })];
        _account_number_decorators = [sequelize_typescript_1.Unique, (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING(10), allowNull: false })];
        _balance_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DECIMAL(10, 2), allowNull: false, defaultValue: 0.00 })];
