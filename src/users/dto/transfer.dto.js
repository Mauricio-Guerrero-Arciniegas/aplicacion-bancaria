...
var TransferDto = function () {
    ...
    return _a = /** @class */ (function () {
            function TransferDto() {
                this.toUserId = __runInitializers(this, _toUserId_initializers, void 0);
        ...
        (function () {
            ...
            _toUserId_decorators = [(0, class_validator_1.IsUUID)('4', { message: 'El ID del usuario destinatario debe ser un UUID válido' }), (0, class_validator_1.IsNotEmpty)({ message: 'El destinatario es obligatorio' })];
            _amount_decorators = [(0, class_validator_1.IsNumber)({}, { message: 'El monto debe ser un número' }), (0, class_validator_1.Min)(0.01, { message: 'El monto debe ser mayor a 0' })];
            _description_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'La descripción debe ser un texto' })];
