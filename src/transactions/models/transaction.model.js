...
var Transaction = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'transactions', timestamps: false })];
    ...
    var _transaction_date_decorators;
    var _transaction_date_initializers = [];
    var _transaction_date_extraInitializers = [];
    ...
    var Transaction = _classThis = /** @class */ (function (_super) {
        ...
        function Transaction_1() {
            ...
            _this.transaction_date = (__runInitializers(_this, _amount_extraInitializers), __runInitializers(_this, _transaction_date_initializers, void 0));
            _this.description = (__runInitializers(_this, _transaction_date_extraInitializers), __runInitializers(_this, _description_initializers, void 0));
    ...
    (function () {
        ...
        _sender_id_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return user_model_1.User; }), (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.UUID, allowNull: false })];
        _receiver_id_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return user_model_1.User; }), (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.UUID, allowNull: false })];
        _amount_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DECIMAL(10, 2), allowNull: false })];
        _transaction_date_decorators = [sequelize_typescript_1.CreatedAt, (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DATE, defaultValue: sequelize_typescript_1.DataType.NOW })];
        _description_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.TEXT, allowNull: true })];
        ...
        __esDecorate(null, null, _transaction_date_decorators, { kind: "field", name: "transaction_date", static: false, private: false, access: { has: function (obj) { return "transaction_date" in obj; }, get: function (obj) { return obj.transaction_date; }, set: function (obj, value) { obj.transaction_date = value; } }, metadata: _metadata }, _transaction_date_initializers, _transaction_date_extraInitializers);
